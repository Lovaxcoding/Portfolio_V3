          ...
          <div className="relative pt-24 md:pt-36">
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    <span className="text-foreground text-sm">
                      Découvrez mon travail et mes compétences !
                    </span>
                ...
                >
                  Passionné par la création de solutions web robustes et
                  intuitives, du front-end au back-end, avec une expertise en
                  Next.js, React et PostgreSQL.
                </TextEffect>
            ...
            >
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                ...
                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-2 md:p-4 shadow-lg shadow-zinc-950/15 ring-1">
                  {" "}
                  {/* Diminué le padding pour mobile */}
                  {/* Idéalement, remplacez ces images par une capture d'écran d'un de VOS projets ou un aperçu de code */}
                  {/* Image pour le thème sombre (visible en mode sombre) */}
                  <Image
                    className="bg-background relative hidden rounded-xl dark:block w-full h-auto" // Utilisation de w-full h-auto pour le responsive
                    src="/profil.png" // Chemin vers votre propre capture d'écran pour le thème sombre
                    alt="Capture d'écran de mon application (thème sombre)"
                    width={2700} // Gardez les dimensions originales pour l'optimisation par Next/Image
                    height={1440} // Gardez les dimensions originales
                    sizes="(max-width: 768px) 100vw, (max-width: 1200px) 70vw, 900px" // Ajoutez sizes pour une meilleure optimisation responsive
                    priority // Si c'est l'image principale visible à l'écran
                  />
                  {/* Image pour le thème clair (visible en mode clair) */}
                  <Image
                    className="z-2 border-border/25 relative rounded-xl border dark:hidden w-full h-auto" // Utilisation de w-full h-auto pour le responsive
                    src="/profil2.png" // Chemin vers votre propre capture d'écran pour le thème clair
                    alt="Capture d'écran de mon application (thème clair)"
                    width={2700} // Gardez les dimensions originales
                    height={1440} // Gardez les dimensions originales
                    sizes="(max-width: 768px) 100vw, (max-width: 1200px) 70vw, 900px" // Ajoutez sizes
                    priority // Si c'est l'image principale visible à l'écran
                  />
                </div>
              </div>
